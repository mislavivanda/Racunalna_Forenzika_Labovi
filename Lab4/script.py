...
def figMetaData(file_path):
    ...
    print(f"{dir(img_doc)}\n")
    print(f"Gps longitude {convertGPScoordinate(img_doc.gps_longitude,img_doc.gps_longitude_ref)}\n")
    print(f"Gps latitude {convertGPScoordinate(img_doc.gps_latitude,img_doc.gps_latitude_ref)}\n")
    webbrowser.open_new_tab("http://www.google.com/maps/place/"+ str(convertGPScoordinate(img_doc.gps_latitude,img_doc.gps_latitude_ref))+","+str(convertGPScoordinate(img_doc.gps_longitude,img_doc.gps_longitude_ref)))
